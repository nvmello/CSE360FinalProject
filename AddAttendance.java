...
public class AddAttendance {
	...
	public void setAttendance(File csv,String [][] roster) {
		...
		try {
	        ...
	        unknownUser = new String[rowNum][2];
	        ...
	        while((line = buffer.readLine()) != null) { //filling in the attendance array
	        	...
	        	if(search(roster,currentSize) == -1) {	//adding those who are not in the JTable
	        		System.out.println(line.split(delimeter));
	        		unknownUser[count]= line.split(delimeter);
	        	}
	        }
